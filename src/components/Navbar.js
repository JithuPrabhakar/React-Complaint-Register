  ...
  return (
    <header>
        ...
        <nav ref={ navRef }>
            ...
            <Link onClick={ hideNavbar } to="about">About Us</Link>
            <Link onClick={ hideNavbar } to='register'>Services and Complaints</Link>
            <Link onClick={ hideNavbar } to='contact'>Contact Us</Link>
            <button ref={ btnRef } className='nav-btn nav-close-btn' onClick={ showNavbar }>
                <FaTimes />
            </button>
        </nav>
